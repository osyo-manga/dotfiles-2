...
"syn keyword processingFunUsage	contained abs acos alpha ambient ambientLight
"syn keyword processingFunUsage	contained append applyMatrix arc arraycopy
"syn keyword processingFunUsage	contained asin atan atan2 background
"syn keyword processingFunUsage	contained beginCamera beginRecord beginShape
"syn keyword processingFunUsage	contained bezier bezierDetail bezierPoint
"syn keyword processingFunUsage	contained bezierTangent bezierVertex binary
"syn keyword processingFunUsage	contained blend blendColor blue box
"syn keyword processingFunUsage	contained brightness camera ceil colorMode
"syn keyword processingFunUsage	contained concat constrain cos createFont
"syn keyword processingFunUsage	contained createGraphics createImage
"syn keyword processingFunUsage	contained createWriter cursor curve
"syn keyword processingFunUsage	contained curveDetail curvePoint
"syn keyword processingFunUsage	contained curveTightness curveVertex day
"syn keyword processingFunUsage	contained degrees delay directionalLight dist
"syn keyword processingFunUsage	contained ellipse ellipseMode emissive
"syn keyword processingFunUsage	contained endCamera endRecord endShape exit
"syn keyword processingFunUsage	contained exp expand fill filter floor
"syn keyword processingFunUsage	contained frustum get green hex hint hour hue
"syn keyword processingFunUsage	contained image imageMode join keyReleased
"syn keyword processingFunUsage	contained keyTyped lerp lerpColor
"syn keyword processingFunUsage	contained lightFalloff lights lightSpecular
"syn keyword processingFunUsage	contained line link loadBytes loadFont
"syn keyword processingFunUsage	contained loadImage loadPixels loadStrings
"syn keyword processingFunUsage	contained log loop mag map match max millis
"syn keyword processingFunUsage	contained min minute modelX modelY modelZ
"syn keyword processingFunUsage	contained month mouseClicked mouseDragged
"syn keyword processingFunUsage	contained mouseMoved mouseReleased nf nfc nfp
"syn keyword processingFunUsage	contained nfs noCursor noFill noise
"syn keyword processingFunUsage	contained noiseDetail noiseSeed noLoop norm
"syn keyword processingFunUsage	contained normal noSmooth noStroke noTint
"syn keyword processingFunUsage	contained open openStream ortho param
"syn keyword processingFunUsage	contained perspective list beginDraw endDraw
"syn keyword processingFunUsage	contained blend copy mask set point
"syn keyword processingFunUsage	contained pointLight popMatrix pow
"syn keyword processingFunUsage	contained printCamera printMatrix
"syn keyword processingFunUsage	contained printProjection close flush print
"syn keyword processingFunUsage	contained println pushMatrix quad radians
"syn keyword processingFunUsage	contained random randomSeed rect rectMode red
"syn keyword processingFunUsage	contained redraw resetMatrix reverse rotate
"syn keyword processingFunUsage	contained rotateX rotateY rotateZ round
"syn keyword processingFunUsage	contained saturation save saveBytes saveFrame
"syn keyword processingFunUsage	contained saveStrings scale screenX screenY
"syn keyword processingFunUsage	contained screenZ second shininess
"syn keyword processingFunUsage	contained shorten sin size smooth sort
"syn keyword processingFunUsage	contained specular sphere sphereDetail splice
"syn keyword processingFunUsage	contained split splitTokens spotLight sq sqrt
"syn keyword processingFunUsage	contained status str charAt equals indexOf
"syn keyword processingFunUsage	contained length substring toLowerCase
"syn keyword processingFunUsage	contained toUpperCase stroke strokeCap
"syn keyword processingFunUsage	contained strokeJoin strokeWeight subset tan
"syn keyword processingFunUsage	contained text textAlign textAscent
"syn keyword processingFunUsage	contained textDescent textFont textLeading
"syn keyword processingFunUsage	contained textMode textSize texture
"syn keyword processingFunUsage	contained textureMode textWidth tint
"syn keyword processingFunUsage	contained translate triangle trim unbinary
"syn keyword processingFunUsage	contained unhex unhint updatePixels vertex
"syn keyword processingFunUsage	contained year keyPressed mousePressed
"syn keyword processingFunUsage	contained frameRate

syn keyword processingFunction contained draw setup stop
...
"syn match   processingFunUsageRegion "\K\k*\s*\ze(" contains=processingFunUsage

" KEYWORD1

syn keyword processingType contained  Boolean Byte Character Class Double Float
syn keyword processingType contained  Integer Math String StringBuffer Thread
syn keyword processingType contained  Array Object PFont PGraphics PImage
syn keyword processingType contained  PrintWriter
syn keyword processingType contained  boolean byte char color double float
syn keyword processingType contained  int long short void
syn keyword processingType super this import
syn keyword processingType break continue return new

syn keyword processingBoolean	false true
syn keyword processingBoolean	&& ||
syn keyword processingConstant	null

syn keyword processingStorageClass	final static synchronized transient volatile 
syn keyword processingConditional	if else  ? : switch case default
...
syn keyword processingKeyword	extends implements throws
...
hi def link processingFunUsage      Type
...
hi def link processingNumber		Type
hi def link processingOctal		    type
hi def link processingOctalZero		PreProc
hi def link processingColor		    Number
hi def link processingFloat		    Type
hi def link processingString		String
hi def link processingCharacter		String
